...
Info  : https://brightdata.co.kr/products/insights/price-tracker/firstcry
"""
...
# https://brightdata.co.kr/products/web-scraper/firstcry
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your FirstCry scraper at: https://brightdata.co.kr/products/web-scraper/firstcry\n"
